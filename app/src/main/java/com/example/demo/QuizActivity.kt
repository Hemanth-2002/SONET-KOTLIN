...
class QuizActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onClick(v: View){
        ...
        when(v.id){
            R.id.tv_option_one ->{
                selectedOption(optionList.get(0),R.drawable.selected_options_border_bg)
                selectedChoice=1
            }
            R.id.tv_option_two ->{
                selectedOption(optionList.get(1),R.drawable.selected_options_border_bg)
                selectedChoice=2
            }
            R.id.tv_option_three ->{
                selectedOption(optionList.get(2),R.drawable.selected_options_border_bg)
                selectedChoice=3
            }
            R.id.tv_option_four ->{
                selectedOption(optionList.get(3),R.drawable.selected_options_border_bg)
                selectedChoice=4
            }
        }
    }
    ...
    private fun defaultOption(){
        optionList.get(0).background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
        optionList.get(1).background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
        optionList.get(2).background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
        optionList.get(3).background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
    }
}