...
class QuizActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onClick(v: View){
        ...
        when(v.id){
            R.id.tv_option_one ->{
                selectedOption(optionOne,R.drawable.selected_options_border_bg)
            }
            R.id.tv_option_two ->{
                selectedOption(optionTwo,R.drawable.selected_options_border_bg)
            }
            R.id.tv_option_three ->{
                selectedOption(optionThree,R.drawable.selected_options_border_bg)
            }
            R.id.tv_option_four ->{
                selectedOption(optionFour,R.drawable.selected_options_border_bg)
            }
        }
    }
    ...
    private fun defaultOption(){
        optionOne.background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
        optionTwo.background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
        optionThree.background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
        optionFour.background = ContextCompat.getDrawable(this,R.drawable.default_options_border_bg)
    }
}
